...
l1.append(69);
print(l1);
# insert(index, element) is used to insert an element at a specific index in the list. It takes two arguments: the index where you want to insert the element and the element itself.
...
print(l1)
# tuple is basically a list but its nature is immutable it will react similar to string
